 ...
 * 
 */
package models.parametres;
import models.utilites.*;
...
public class Electeur extends Personne{
	...
	/**
	 * Rapprochement proportionnelement � l'utilit�
	 * @param p
	 * @param utilite
	 */
	...
	//Diagramme de s�quence � faire
	/**
	 * On se rapproche ou on s'�loigne par discussion
	 * @param p
	 */
	...
	/**
	 * En fonction des pr�ferences parmi N personnes
	 * @param sondage
	 * @param N
	 */
	...
	/**
	 * On s'�loigne ou on se rappoche en fonction du candidat ayant l utilit� la plus �lev�e
	 * @param sondage
	 */
	...
	/**
	 * En fonction de l'utilit� de chaque candidats
	 * @param sondage
	 */
